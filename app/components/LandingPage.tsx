...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden" style={{backgroundColor: '#111113'}}>
      ...
      {/* Footer */}
      <footer ref={contactRef} className="relative z-10">
        {/* Background overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-black to-gray-900"></div>
        
        {/* Top border with gradient and shadow effect */}
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gray-600/50 to-transparent shadow-sm"></div>
            ...
            <div className="grid md:grid-cols-5 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-200 hover:scale-110 transform">
              ...
              {/* Product */}
              <div className="space-y-6">
                <h3 className="text-white font-medium text-sm tracking-wide">Product</h3>
                <ul className="space-y-3 text-sm">
                  <li><button onClick={() => scrollToSection(pricingRef)} className="text-gray-500 hover:text-gray-300 transition-colors duration-200">Pricing</button></li>
                  <li><a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-200">Downloads</a></li>
                </ul>
              </div>

              {/* Resources */}
              <div className="space-y-6">
                <h3 className="text-white font-medium text-sm tracking-wide">Resources</h3>
                <ul className="space-y-3 text-sm">
                  <li><a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-200">Docs</a></li>
                  <li><a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-200">Blog</a></li>
                  <li><button onClick={() => scrollToSection(faqRef)} className="text-gray-500 hover:text-gray-300 transition-colors duration-200">FAQs</button></li>
                  <li><a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-200">Changelog</a></li>
                </ul>
              </div>

              {/* Terms */}
              <div className="space-y-6">
                <h3 className="text-white font-medium text-sm tracking-wide">Terms</h3>
                <ul className="space-y-3 text-sm">
                  <li><a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-200">Terms of Service</a></li>
                  <li><a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-200">Privacy Policy</a></li>
                </ul>
              </div>

              {/* Connect */}
              <div className="space-y-6">
                <h3 className="text-white font-medium text-sm tracking-wide">Connect</h3>
                <ul className="space-y-3 text-sm">
                  <li><a href={`mailto:${siteSettings?.contact_email || 'hello@indexnow.studio'}`} className="text-gray-500 hover:text-gray-300 transition-colors duration-200">Contact ↗</a></li>
                  <li><a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-200">Forum</a></li>
                </ul>
              </div>
            </div>

            {/* Copyright section */}
            <div className="border-t border-gray-800/60 mt-12 pt-8">
