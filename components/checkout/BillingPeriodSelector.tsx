                      ...
                      >
                        <div className="flex items-center justify-between w-full">
                          <div className="flex items-center space-x-2">
                            ...
                            {discount > 0 && (
                              <span className="bg-[#4BB543] text-white text-xs px-2 py-0.5 rounded-full">
                                {discount}% off
                              </span>
                            )}
                            {option.period === 'annual' && (
                              <span className="bg-[#3D8BFF] text-white text-xs px-2 py-0.5 rounded-full">
                                Popular
                              </span>
                            )}
                          </div>
                          ...
                          <div className="text-right">
                            ...
                            {monthlySavings && (
                              <div className="text-xs text-[#4BB543]">
                                Save {formatCurrency(monthlySavings, userCurrency)}/mo
                              </div>
                            )}
                          </div>
                        </div>
