...
export default function PageForm({ 
  ...
  useEffect(() => {
    if (mode === 'edit' && initialData?.slug && initialData?.title) {
      const autoGeneratedSlug = generateSlug(initialData.title)
      // If the current slug doesn't match what would be auto-generated, mark as manually edited
      if (initialData.slug !== autoGeneratedSlug) {
        setSlugManuallyEdited(true)
      }
    }
  }, [mode, initialData?.slug, initialData?.title])
